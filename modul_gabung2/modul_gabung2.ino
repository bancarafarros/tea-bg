...
void modulKirimData() {
    ...
    String ketinggianAirMm;

    if (ketinggianAir <= 480) {
        String ketinggianAirMm = "0 mm";
      
      } else if (ketinggianAir > 480 && ketinggianAir <= 530) {
        String ketinggianAirMm = "0 mm - 5 mm";
      
      } else if (ketinggianAir > 530 && ketinggianAir <= 615) {
        String ketinggianAirMm = "5mm - 10mm";
      
      } else if (ketinggianAir > 615 && ketinggianAir <= 660) {
        String ketinggianAirMm = "10 mm - 15 mm";
      
      } else if (ketinggianAir > 660 && ketinggianAir <= 680) {
        String ketinggianAirMm = "15 mm - 20 mm";
      
      } else if (ketinggianAir > 680 && ketinggianAir <= 690) {
        String ketinggianAirMm = "20 mm - 25 mm";
      
      } else if (ketinggianAir > 690 && ketinggianAir <= 700) {
        String ketinggianAirMm = "25 mm - 30 mm";
      
      } else if (ketinggianAir > 700 && ketinggianAir <= 705) {
        String ketinggianAirMm = "30 mm - 35 mm";
      
      } else if (ketinggianAir > 705) {
        String ketinggianAirMm = "35 mm - 40 mm";
      }
      // BACA KETINGGIAN AIR
    
    // String dataKirim = "#" + String(ketinggianAir) + "#" + String(suhu) + "#" + String(kelembaban) + "#" + String(hari) + "#" + String(tanggal) + "#" + String(bulan) + "#" + String(tahun) + "#" + String(jam) + "#" + String(menit) + "#" + String(detik);
    String dataKirim = "#" + ketinggianAirMm + "#" + String(suhu) + "#" + String(kelembaban) + "#" + String(hari) + "#" + String(tanggal) + "#" + String(bulan) + "#" + String(tahun) + "#" + String(jam) + "#" + String(menit) + "#" + String(detik);
    Serial.println(dataKirim);
    delay(5000);
}
// MODUL KIRIM DATA

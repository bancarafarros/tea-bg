...
void modulKirimData() {
    ...
    // Cek apakah sudah mencapai interval waktu tertentu
    if (currentMillis - previousMillis >= interval) {
        String dataKirim = "#" + String(ketinggianAirMm) + "#" + String(suhu) + "#" + String(kelembaban) + "#" + String(statusPakan) + "#" + String(statusKipasSuhu) + "#" + String(statusKipasKelembaban) + "#" + String(statusPompa) + "#" + String(statusLampuSuhu) + "#" + String(statusLampuMalam);
